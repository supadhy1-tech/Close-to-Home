...
<section class="section" style="background: #fff;">
    <div class="container">
        ...
        // Build query filter for Saginaw only
        $filter = [
            'approved' => true,
            'location' => 'saginaw'
        ];
...
<section class="section" style="background: #f8f9fa;">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 2rem;">
            ...
            <div style="position: relative; overflow: hidden; border-radius: 10px; height: 250px; background: #e0e0e0;">
                <img src="images/gallery/activity-center.jpg" alt="Saginaw Activities" style="width: 100%; height: 100%; object-fit: cover;">
                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(0,0,0,0.7), transparent); padding: 1.5rem; color: white;">
            ...
            <div style="position: relative; overflow: hidden; border-radius: 10px; height: 250px; background: #e0e0e0;">
                <img src="images/gallery/fitness-center.jpg" alt="Saginaw Fitness" style="width: 100%; height: 100%; object-fit: cover;">
                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(0,0,0,0.7), transparent); padding: 1.5rem; color: white;">
                    <h3 style="font-size: 1.2rem; margin-bottom: 0.3rem;">Wellness Center</h3>
                    <p style="font-size: 0.9rem; opacity: 0.9;">Stay active & healthy</p>
                </div>
            </div>
        </div>
