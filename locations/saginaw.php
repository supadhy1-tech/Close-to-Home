...
<section class="hero-section" style="min-height: 50vh; background: linear-gradient(135deg, rgba(26, 77, 46, 0.3) 0%, rgba(76, 139, 99, 0.25) 100%), url('/images/gallery/close.jpg') center/cover no-repeat; display: flex; align-items: center; position: relative; filter: contrast(1.2) brightness(1.05);">
    <div class="hero-content" style="position: relative; z-index: 2; text-align: center; color: rgba(255, 255, 255, 0.95); max-width: 1200px; margin: 0 auto; padding: 3rem 2rem; background: rgba(0, 0, 0, 0.2); backdrop-filter: blur(3px); border-radius: 15px;">
        <h1 style="font-size: 3.5rem; margin-bottom: 1rem; text-shadow: 2px 2px 8px rgba(0,0,0,0.6); font-weight: 300; letter-spacing: 1px;">
            <i class="fas fa-map-marker-alt" style="color: #d4a373;"></i> Close to Home-Saginaw
        </h1>
        <p class="subtitle" style="font-size: 1.5rem; color: rgba(212, 163, 115, 0.9); font-weight: 400; text-shadow: 1px 1px 4px rgba(0,0,0,0.5);">2160 N Center Rd, Saginaw, MI 48603</p>
    </div>
</section>
...
<section class="section" style="background: #f8f9fa;">
    <div class="container">
        <div class="section-header">
            <h2>About Our Saginaw Community</h2>
            <p>A welcoming home where comfort meets exceptional care</p>
        </div>
        
        <div style="max-width: 900px; margin: 0 auto;">
            <div class="card">
                <p style="font-size: 1.1rem; line-height: 1.8; margin-bottom: 1.5rem;">
                    Our Saginaw location has been serving families in the greater Saginaw area for years, providing compassionate care in a warm, home-like environment. Conveniently located near Highway 75, we're easily accessible from Saginaw, Zilwaukee, Frankenmuth, and surrounding communities.
                </p>
                <p style="font-size: 1.1rem; line-height: 1.8; margin-bottom: 1.5rem;">
                    With spacious common areas, beautifully landscaped grounds, and modern amenities, our Saginaw facility offers everything you need for comfortable, enriching senior living. Our dedicated team is committed to making every resident feel valued, supported, and truly at home.
                </p>
            </div>
        </div>
    </div>
...
<section class="section" style="background: #fff;">
    <div class="container">
        <div class="section-header">
            <h2>Services at Our Saginaw Location</h2>
...
<section class="section" style="background: #f8f9fa;">
    <div class="container">
        <div class="section-header">
            <h2>Amenities at Our Saginaw Location</h2>
    ...
    <h4>Therapy & Behavioral Care</h4>
    <p>Professional mental health and wellness support</p>
</div>
        </div>
    </div>
</section>
...
<section class="section" style="background: #fff; padding: 4rem 2rem;">
    <div class="container">
        <div style="max-width: 800px; margin: 0 auto; text-align: center; background: linear-gradient(135deg, #1a4d2e 0%, #2d7a4c 100%); padding: 4rem 3rem; border-radius: 15px; color: #fff;">
            <h2 style="font-size: 2.5rem; margin-bottom: 1.5rem; color: #fff;">Visit Our Saginaw Location</h2>
            ...
            <div style="display: flex; gap: 1.5rem; justify-content: center; flex-wrap: wrap;">
                <a href="/contact.php?location=saginaw#tour-section" class="btn-primary" style="background: #fff; color: #1a4d2e;">Schedule a Tour</a>
                <a href="tel:9894013581" class="btn-secondary" style="background: rgba(255,255,255,0.2); backdrop-filter: blur(10px);"><i class="fas fa-phone"></i> Call Us: (989) 401-3581</a>
            </div>
        </div>
    </div>
</section>
